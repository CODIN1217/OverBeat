...
public class ProgressBar : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        PBBGImageRend.color = playGM.GetPlayerScript(0).centerColor;
        PBVertexRend0.color = playGM.GetPlayerScript(0).sideColor;
        PBVertexRend1.color = playGM.GetPlayerScript(0).sideColor;
    }
}
