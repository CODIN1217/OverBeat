...
public class ProgressBar : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        PBBGImageRend.color = playGM.GetWorldInfo(0, playGM.closestNoteIndex[0]).playerInfo[0].centerColorTween.value;
        PBVertexRend0.color = playGM.GetWorldInfo(0, playGM.closestNoteIndex[0]).playerInfo[0].sideColorTween.value;
        PBVertexRend1.color = playGM.GetWorldInfo(0, playGM.closestNoteIndex[0]).playerInfo[0].sideColorTween.value;
    }
}
